# Herring Frame Extractor - Mac VS Code Version
...
If your video is named `HerringVideo.mp4`, either rename it to `Herring.mp4` or update the command in `run_mac.sh`.
